...
if(isset($_POST['update_payment'])){
   ...
   $message[] = 'Төлбөрийн статус шинэчлэгдсэн!';
}
...
<h1 class="heading">Захиалга өгсөн</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('Захиалгыг устгана уу?');">Устгах</a>
        </div>
      </form>
   </div>
   <?php
