...
<head>
   ...
   <title>Профайлыг шинэчлэх</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>Профайлыг шинэчлэх</h3>
      <input type="hidden" name="prev_pass" value="<?= $fetch_profile['password']; ?>">
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="хэрэглэгчийн нэрээ оруулна уу" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
