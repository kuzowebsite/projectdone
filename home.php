...
<head>
   ...
   <title>Reliable Online_Shop</title>
...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            <span>50% хүртэл хямдралтай</span>
            <h3>Хамгийн сүүлийн үеийн цагнууд</h3>
            <a href="category.php?category=watch" class="btn">Бараа үзэх</a>
         </div>
      </div>
...
<section class="category">
   ...
   <h1 class="heading">Ангилалаар бараа үзэх</h1>
...
<section class="home-products">
   ...
   <h1 class="heading">Хамгийн сүүлийн үеийн бүтээгдэхүүн</h1>
   ...
   <?php
      ...
      echo '<p class="empty">Хараахан бүтээгдэхүүн нэмээгүй байна!</p>';
   }
   ?>
